...
<div class="header">
	<div class="container">
		<div class="header-main">
			  <div class="logo">
			  	<h1><a href="index.html">Dwarka Runners</a><img src="images/45.jpg"></h1>
			  </div>
        </div>
	</div>
</div>			
...
<div class="banner">
	<div class="container">
		<div class="banner-main">
			<h2>Dwarka Runners</h2>
			<p>Give your best. It has roots in a piece</p>
		</div>
	</div>
</div>
<!--banner end here-->
		 ...
		 <div class="single">
			...
			<div class="col-md-8 ">
				<div class=" single-grid">
					...
					<div class="lone-line">
						<h4>It's very hard at the beginning to understand that the whole idea is not to beat the other runners. </h4>
						<div class="cal">
							<ul>
	...
	<div class="container">
		<div class="footer-main">
			 <div class="col-md-3 ftr-grd">
                <h3>Information</h3>
                <p>Running allows me to set my mind free. Nothing seems impossible. Nothing unattainable.</p>
                <ul class="ftr-icons">
             ...
             <div style="padding-left:200px;"class="col-md-4 ftr-grd">
                 <h3>Site Link</h3>
                <ul class="ftr-links">
             ...
             <div style="padding-left:20px;"class="col-md-3 ftr-grd">
                   <h3>Recent project</h3>
                   <div class="ftr-gd4-img">
				    <div class="col-md-4 ftr-gd4-1"><a href="single.html"><img src="images/f1.jpg" alt="" class="img-responsive"></a></div>
				    <div class="col-md-4 ftr-gd4-1"><a href="single.html"><img src="images/f2.jpg" alt="" class="img-responsive"></a></div>
				    <div class="col-md-4 ftr-gd4-1"><a href="single.html"><img src="images/f3.jpg" alt="" class="img-responsive"></a></div>
				  <div class="clearfix"> </div>
				</div>
				<div class="ftr-gd4-img">
				    <div class="col-md-4 ftr-gd4-1"><a href="single.html"><img src="images/f4.jpg" alt="" class="img-responsive"></a></div>
				    <div class="col-md-4 ftr-gd4-1"><a href="single.html"><img src="images/f5.jpg" alt="" class="img-responsive"></a></div>
				    <div class="col-md-4 ftr-gd4-1"><a href="single.html"><img src="images/f6.jpg" alt="" class="img-responsive"></a></div>
				  <div class="clearfix"> </div>
				</div>
             </div>
          <div class="clearfix"> </div>
...
<div class="copyright">
	<div class="container">
	   <div class="copy-main">
			<p>© 2018. All rights reserved Design by Diwakar ojha </p>
	   </div>
	   <script type="text/javascript">
